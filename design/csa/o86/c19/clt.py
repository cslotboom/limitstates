...
from .element import CltBeamColumnCSA19, _getSection, _getphi
...
def checkMrCltBeam(element:CltBeamColumnCSA19, knet:float = 1, 
...
def checkCltBeamShear(element:CltBeamColumnCSA19, knet:float = 1, 
                        useFire:bool = False, useStrongAxis = True) -> float:
    """
