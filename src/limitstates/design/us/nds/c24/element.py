...
from .fireportection import GypusmRectangleNds24, GypusmFlatNds24

__all__ = ["BeamColumnGlulamNds24", "getBeamColumnGlulamNds24", 
           "BeamColumnCltCsa19", "DesignPropsCltNds24", "DesignPropsGlulamNds24",
           "EleDisplayPropsGlulam19"]

@dataclass
class DesignPropsGlulamNds24:
    """
    ...
    keyC : float
        ...
        length for compression. See table A.4 for guidance. 
    """
    firePortection:GypusmRectangleNds24 = None
...
class BeamColumnGlulamNds24(BeamColumn):
    """
    ...
    """
    designProps:DesignPropsGlulamNds24
    
    def __init__(self, member:Member, section:SectionRectangle,
                 designProps:DesignPropsGlulamNds24 = None, 
...
def getBeamColumnGlulamNds24(L:float, section:SectionRectangle, lUnit:str='m', 
                             firePortection:GypusmRectangleNds24 = None,
                             Lx:float = None, 
                             Ly:float = None,
                             kexB:float = 1,
                             kexC:float = 1,
                             keyC:float = 1) -> BeamColumnGlulamNds24:
    """
    ...
    return BeamColumnGlulamNds24(member, section, designProps)

@dataclass
class DesignPropsCltNds24:
    """
    Design propreties specifically for a glulam beamcolumn element
    """
    firePortection:GypusmFlatNds24 = None
...
def _isGlulam(element:BeamColumn):
    ...
    """
    if isinstance(element, BeamColumnGlulamNds24):
        return True
    else:
        return False
